...
(function (EMOLA) {
    var EventManager = (function () {
        ...
        EventManager.prototype.move = function (color) {
        };
        return EventManager;
    })();
    EMOLA.EventManager = EventManager;
})(EMOLA || (EMOLA = {}));
EMOLA.External = {};
EMOLA.External.createTestList = function () {
    ...
    var testList = new EMOLA.List([new EMOLA.Atom(EMOLA.Atom.MINUS, null), new EMOLA.Atom(EMOLA.Atom.INT, 2), new EMOLA.Point(400, 200), childList], null, new EMOLA.Point(400, 200));
...
EMOLA.List.prototype.isMet = function (point) {
    if (this.point.x - EMOLA.List.NODE_RADIUS <= point.x && point.x <= this.point.x + EMOLA.List.NODE_RADIUS && this.point.y - EMOLA.List.NODE_RADIUS <= point.y && point.y <= this.point.y + EMOLA.List.NODE_RADIUS) {
        return true;
    }
    return false;
};
...
//# sourceMappingURL=emola-ts.js.map
